        ...
        public static void InicializarTerritorios(Juego juego)
        {
            ...
            if (juego.TipoMapa == Constantes.MAPA_CHINA)
            {
                juego.Territorios = new List<Territorio>(){
                    new Territorio() { TerritorioId = 0, NombreTerritorio="Huijiang", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 1, NombreTerritorio="Tibet", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 2, NombreTerritorio="Qinghai", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 3, NombreTerritorio="Sichuan", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 4, NombreTerritorio="Yunnan", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 5, NombreTerritorio="Guizhou", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 6, NombreTerritorio="Uliassutai", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 7, NombreTerritorio="Mongolia", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 8, NombreTerritorio="Gansu", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 9, NombreTerritorio="Shaanxi", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 10, NombreTerritorio="Shanxi", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 11, NombreTerritorio="Hubei", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 12, NombreTerritorio="Heilongjiang", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 13, NombreTerritorio="Jilin", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 14, NombreTerritorio="Shengjing", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 15, NombreTerritorio="Zhili", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 16, NombreTerritorio="Shandong", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 17, NombreTerritorio="Menan", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 18, NombreTerritorio="Guangxi", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 19, NombreTerritorio="Hunan", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 20, NombreTerritorio="Ilangxi", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 21, NombreTerritorio="Fcohou", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 22, NombreTerritorio="Zhelang", NUnidadesDeplegadas = 0 },
                    new Territorio() { TerritorioId = 23, NombreTerritorio="Anhu", NUnidadesDeplegadas = 0 }
                };
            }
            #endregion
        }
